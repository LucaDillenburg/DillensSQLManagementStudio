...
namespace EducativeSQLManagementStudio
{
    public partial class FrmMain : Form
    {
        ...
        //general
        protected const string TITLE = "Educative SQL Management Studio (Dillenburg's Product)";
        ...
        protected void FrmMain_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
        ...
        protected void FrmMain_KeyDown(object sender, ref KeyEventArgs e)
        {
            e.Handled = true;
            if (e.KeyCode == Keys.F5) //F5
                this.executeToolStripMenuItem.PerformClick();
        ...
        protected void allowToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (this.allowNotification)
                ...
                this.allowOrNotNotificationsToolStripMenuItem.Image = global::EducativeSQLManagementStudio.Properties.Resources.switch_off2;
        }
        ...
        protected void txtFind_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                this.FrmMain_KeyDown(sender, ref e);
        ...
        protected void newRchtxtCode_PreviewKeyDown(object sender, PreviewKeyDownEventArgs e)
        {
            ...
            this.FrmMain_PreviewKeyDown(null, e);
        ...
        {
            this.btnClose.Image = global::EducativeSQLManagementStudio.Properties.Resources.btnClose_Hover1;
        }
        ...
        {
            this.btnMinimize.Image = global::EducativeSQLManagementStudio.Properties.Resources.btnMinimize_Hover;
        }
